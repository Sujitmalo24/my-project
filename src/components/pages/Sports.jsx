...
import sport1 from "../../assets/images/sports-img/sport-1.jpg";
import sport2 from "../../assets/images/sports-img/sport-2.jpg";
import sport3 from "../../assets/images/sports-img/sport-3.jpg";
import sport4 from "../../assets/images/sports-img/sport-4.jpg";
import sport5 from "../../assets/images/sports-img/sport-5.jpg";
...
const categories = [
  { name: "Team Sports", color: "from-blue-400 to-blue-600" },
  { name: "Racquet Sports", color: "from-green-400 to-green-600" },
  { name: "Fitness", color: "from-pink-400 to-pink-600" },
  { name: "Footwear", color: "from-yellow-400 to-yellow-600" },
  { name: "Cycling", color: "from-purple-400 to-purple-600" },
];

const Sports = () => (
  <div className="max-w-7xl mx-auto py-16 px-4">
    <h1 className="text-4xl font-extrabold text-indigo-700 mb-4 tracking-tight">Sports</h1>
    <p className="text-gray-700 text-lg mb-10">Shop sports equipment, apparel, and accessories for all your athletic needs.</p>
